var menuState = {
    ...
    create: function() { 
        // Name of the game
        var nameLabel = game.add.text(game.width/2, 80, 'Joust!', { font: '50px Arial', fill: '#ffffff' });
        nameLabel.anchor.setTo(0.5, 0.5);
        
        //Last Winner
        var lastWinnerLabel = game.add.text(game.width/2, game.height/2, "last winner was:" + game.global.last_winner, { font: '25px Arial', fill: '#ffffff'});
        
        lastWinnerLabel.anchor.setTo(0.5);
